...
* tgetent, tgetflag, tgetnum, tgetstr, tgoto, tputs
  ...
  * tputs 루틴에 대한 설명은 curs_terminfo(3X) 매뉴얼 페이지에 있습니다. 이는 termcap 또는 terminfo 이름으로 능력을 검색할 수 있습니다.  
  ...
  >   ospeed 변수는 시스템별 코딩을 사용하여 터미널 속도를 반영하기 위해 ncurses에 의해 설정됩니다.  
  
  반환 값  
  >   명시적으로 언급되지 않은 경우, 정수를 반환하는 루틴은 실패 시 ERR을 반환하고 성공 시 OK를 반환합니다 (SVr4에서는 "ERR이 아닌 정수 값"만을 명시합니다).  
  >   포인터를 반환하는 루틴은 오류 발생 시 NULL을 반환합니다.  
